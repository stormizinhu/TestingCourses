...
import { BookOpen, Target, Calendar, MessageSquare, Trophy, Flame, Award, TrendingUp, ArrowRight, CheckCircle } from 'lucide-react';

const Dashboard = () => {
  const { user } = useAuth();

  const stats = [
    { label: 'Pontos', value: user?.points || 0, icon: Trophy, color: 'text-yellow-500' },
    { label: 'Streak', value: `${user?.streak || 0} dias`, icon: Flame, color: 'text-orange-500' },
    { label: 'Badges', value: user?.badges?.length || 0, icon: Award, color: 'text-purple-500' },
    { label: 'Progresso', value: '45%', icon: TrendingUp, color: 'text-green-500' },
  ];

  const quickActions = [
    { title: 'Continuar Trilha', description: 'Testes de API com Postman', href: '/tracks/intermediario', icon: BookOpen, color: 'bg-blue-500' },
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            >
              ...
              <Link to="/tracks/intermediario" className="block group">
                <div className="bg-muted/50 p-4 rounded-lg hover:bg-muted transition-colors">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-semibold text-primary">Testes de API com Postman</p>
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <p className="text-sm text-muted-foreground flex-grow">Completou a aula <span className="font-semibold text-foreground">"Introdução ao Postman"</span></p>
            ...
            <div className="flex items-center">
              ...
              <p className="text-sm text-muted-foreground flex-grow">Ganhou badge <span className="font-semibold text-foreground">"Primeiro Quiz"</span></p>
            ...
            <div className="flex items-center">
              ...
              <p className="text-sm text-muted-foreground flex-grow">Respondeu no fórum <span className="font-semibold text-foreground">"Como criar testes de API"</span></p>
